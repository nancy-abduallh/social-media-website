...
@section('content')
    ...
    @if (empty(request()->get('blog_id')))
        <form method="GET" action="{{ route('posts.create') }}" enctype="multipart/form-data">
    ...
    @if (!empty(request()->get('blog_id')))
        <form method="POST" action="{{ route('posts.store') }}">
            ...
            <div class="flex flex-col mb-3">
                ...
                <x-input type="file" name="image" id="image" accept="image/*" required /> <!-- Ensure this is present -->
            </div>
